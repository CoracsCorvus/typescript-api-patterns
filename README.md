> Этот репозиторий используется как пример технической документации.
> 
> Он демонстрирует:
> - описание архитектуры и API;
> - примеры использования для разработчиков;
> - справочную документацию (API Reference);
> - release notes и работу с изменениями.
> 
> Код используется как контекст для документации и не является основной целью проекта.
